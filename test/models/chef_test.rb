...
class ChefTest < ActiveSupport::TestCase
  ...
  test "email should accept correct format" do
    ...
    valid_emails.each do |valids| #create an array of valid emails and then iterate them and insert each that inspects through each iteration
      @chef.email = valids
  ...
  test "email should be unique and case insensitive" do
    duplicate_chef = @chef.dup #creating a duplicate of the chef need to make it case insensitive
